...
let noOfActivities = 1;
		...
		function createJEEMInput(){
			...
			if(cet.checked == true){
				...
				if(temp == null){
                    console.log("OK")
                    var cetWDiv = document.createElement('div')
                    cetWDiv.setAttribute("class","col-md-4")
					var cet_div = document.createElement('div')
		...
		function createSATInput(){
			var cet = document.getElementById('sat_check')
			
			if(cet.checked == true){
				
				var temp = document.getElementById('sat_input')
				if(temp == null){
                    console.log("OK")
                    var cetWDiv = document.createElement('div')
                    cetWDiv.setAttribute("class","col-md-4")
					...
					var cet_label = document.createElement('label')
					cet_label.innerHTML = 'SAT Score' 
					var cet_input = document.createElement('input')
					cet_input.setAttribute("type","number")
					cet_input.setAttribute("id","sat_input")
					cet_input.setAttribute("class","form-control form-control-lg")
					cet_input.setAttribute("name","SATScore")
					cet_input.placeholder="SAT"
                    cet_div.setAttribute("id","sat_div")
                    cet_div.setAttribute("class","form-group")
				...
				var cet_div = document.getElementById("sat_div")
				if(cet_div);
					cet_div.parentNode.removeChild(cet_div)
...
function addMoreActivities(){
	...
	leftDiv1.setAttribute('class','form-group')
	var label_l1 = document.createElement('label')
	label_l1.innerHTML = "Level"
	var input_l1 = document.createElement('input')
	input_l1.setAttribute('type','text')
	input_l1.setAttribute('class','form-control form-control-lg')
	input_l1.setAttribute('placeholder','E.g International, National, State, District')
	leftDiv1.appendChild(label_l1)
	leftDiv1.appendChild(input_l1)
	leftDivWrapper.appendChild(leftDiv1)
	...
	rightDiv1.setAttribute('class','form-group')
	var label_l2 = document.createElement('label')
	label_l2.innerHTML = "Score/Grade"
	var input_l2 = document.createElement('input')
	input_l2.setAttribute('type','text')
	input_l2.setAttribute('class','form-control form-control-lg')
	input_l2.setAttribute('placeholder','Score/Grade achieved in the activity')
	rightDiv1.appendChild(label_l2)
	rightDiv1.appendChild(input_l2)
	rightDivWrapper.appendChild(rightDiv1)
